...
하지만 이세상에서 발생하는 대부분의 일들은 대체로 다른 일들에 영향을 끼치고 만다. ~~(그렇기에 세상일은 예측하기가 어렵다)~~
...
$$
```
<center><font size="8px">조건부확률</font></center>
...
$$
```
<center><font size="8px">베이즈 정리</font></center>
...
쉽게 말하기위해 앞서 들었던 치킨조각 사례를 들어보겠다.
...
<center><del><font size="8px">나이브 베이즈는 근성없는 유사 치킨을 계산하지 않습니다</font></del></center>
...
편리하게도 카카오가 이미 계산에 필요한 확률값들을 제공하고 있다. ~~정답도 덤으로~~
